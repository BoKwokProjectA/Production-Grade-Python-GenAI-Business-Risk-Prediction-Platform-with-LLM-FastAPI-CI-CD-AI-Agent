...
get_ipython().system('pip install -U nbformat nbconvert jupyter')


# In[ ]:


get_ipython().system("python - <<'PY'")
import nbformat
...
get_ipython().system('jupyter nbconvert --to html Rag_assistant1.ipynb')
