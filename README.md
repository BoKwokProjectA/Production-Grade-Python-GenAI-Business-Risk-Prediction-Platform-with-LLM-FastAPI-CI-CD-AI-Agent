# Full-Stack AI Business Risk Prediction Platform with AI Agent and AI Automation: Post-Graduation Project
# Technology Stack: Backend: Python, FastAPI, SQLAlchemy and Pydantic v2; UI/UX Frontend: React, TypeScript, Vite, Tailwind CSS, HTML and CSS; DevOps, MLOps and Cloud: Docker, GitHub Actions CI/CD, Azure Container Apps, Google Cloud Run and Vercel; AI Agent: Microsoft Copilot Studio, GenAI, RAG, Large Language Models, LangChain, FAISS, Sentence Transformers and SharePoint; AI Automation: Microsoft Power Platform, Power Automate, Microsoft Teams and Microsoft 365;
